...
if (isset($_POST["request"])) {
  ...
  // For the 2 checkboxes below, both are valid ways of getting usable data
  ...
  if (!$form_values["course-vegetarian"] && !$form_values["course-sauces"]) {
    $form_valid = false;
  ...
  // 7. If the form is valid, show confirmation message. Otherwise, set sticky values
  if ($form_valid == true) {
